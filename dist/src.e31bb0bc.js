...
var CONTRACT_NAME = "dev-1629889372701-4007829" || 'dev.nguyenhuuthang_dev.testnet';
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("C:\\Users\\Boss", "/.near/validator_key.json"),
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _event$target$element = event.target.elements, fieldset = _event$target$element.fieldset, author = _event$target$element.author, content = _event$target$element.content; // disable the form while the value gets updated on-chain
...
document.querySelector('input#content').oninput = function (event) {
